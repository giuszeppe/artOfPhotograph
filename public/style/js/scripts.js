$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        $(".onepage .navbar ul.navbar-nav a").each(function () {
            ...
            var thisPosition =
                thisTruePosition - headerWrapper - offsetTolerance;
    ...
    $(window).scroll(function () {
        ...
        $("#sticky-filter a").each(function () {
            ...
            var stickyThisTruePosition = parseInt(
                $(stickyThisHref).offset().top,
                10
            );
            var stickyThisPosition =
                stickyThisTruePosition - stickyWrapper - stickyOffsetTolerance;
            if (stickyScrollPosition >= stickyThisPosition) {
                $(".current").removeClass("current");
                $("#sticky-filter a[href=" + stickyThisHref + "]")
                    .parent("li")
                    .addClass("current");
            }
        });
        //If we're at the bottom of the page, move pointer to the last section
        var stickyBottomPage =
            parseInt($(document).height(), 10) -
            parseInt($(window).height(), 10);
        if (
    ...
    $(".flickr-feed").dcFlickr({
        ...
        onLoad: function () {
            $(".flickr-feed .item .icon-overlay a").prepend(
