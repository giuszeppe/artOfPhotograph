  ...
  <div class="light-wrapper">
    <div class="container inner">
      <div class="thin">
        <h3 class="section-title text-center">Con cosa lavoro</h3>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="caption-overlay">
            ...
            <div class="caption bottom-right">
              <div class="title">
                <h3 class="main-title layer">Matrimoni</h3>
              </div>
              <!--/.title --> 
            </div>
            <!--/.caption --> 
        ...
        <div class="col-sm-4">
          <div class="caption-overlay">
            ...
            <div class="caption bottom-right">
              <div class="title">
                <h3 class="main-title layer">Battesimi</h3>
              </div>
              <!--/.title --> 
            </div>
            <!--/.caption --> 
        ...
        <div class="col-sm-4">
          <div class="caption-overlay">
            ...
            <div class="caption bottom-right">
              <div class="title">
                <h3 class="main-title layer">Altro</h3>
              </div>
              <!--/.title --> 
            </div>
            <!--/.caption --> 
